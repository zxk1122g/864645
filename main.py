...
def send_message(to_user, access_token, region_name, weather, temp, wind_dir, note_ch, note_en):
    ...
    def replace_txt(txt, weather, temp, max_temp, min_temp, wind_dir, sunrise, sunset, category, pm2p5, proposal,
                    region,
                    today_week, commemoration_data, birthday_data, chp, note_ch, note_en):
